...
every one of the fifteen dies at import and exits 1, which looks exactly like
fifteen broken contracts unless something says otherwise -- and that reading is
...
def requirements(script, _seen=None):
    ...
    recursion changes no answer.  It is here because eight of the fifteen import
